        ...
        <div>
          <header >
            ...
            <div className='rules-p'>
              <p>
                Welcome to the National Parks Odyssey! Here are the instructions on how to play:
              </p>
              <p>
              ...
              <p>
              <strong>Map</strong>: Explore the National Parks on our map, by clicking on the designated park tile. With each park a random minigame will appear, that you will have to beat. If beaten, you will receive a certain amount of points based on your performance, and you will also receivve a Collector's Card of that specific park. Collect them all if you dare!
              </p>
              <p>
